...
object Constant{
    ...
    const val darkBlueHexCode = "#153f69"
    ...
    const val USERS_FILE_NAME = "Users"
    const val USERS_EMAIL_FIELD = "email"
    const val USERS_NAME_FIELD = "name"
    const val USERS_IMAGE_FIELD = "image"
    const val THEME_KEY = "isFromTheme"
